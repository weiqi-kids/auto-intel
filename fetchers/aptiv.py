...
class AptivFetcher(CompanyFetcher):
    """Aptiv 爬蟲"""

    company_id = "aptiv"
    company_name = "Aptiv"
    news_url = "https://www.aptiv.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Aptiv")
        return documents
