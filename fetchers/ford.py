...
class FordFetcher(CompanyFetcher):
    """Ford Motor 爬蟲"""

    company_id = "ford"
    company_name = "Ford Motor"
    news_url = "https://www.fordmotor.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.fordmotor.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Ford Motor")
        return documents
