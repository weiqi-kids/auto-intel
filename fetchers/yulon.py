...
class YulonFetcher(CompanyFetcher):
    """裕隆汽車 爬蟲"""

    company_id = "yulon"
    company_name = "裕隆汽車"
    news_url = "https://www.裕隆汽車.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 裕隆汽車")
        return documents
