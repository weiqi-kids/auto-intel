...
class KendaFetcher(CompanyFetcher):
    """建大工業 爬蟲"""

    company_id = "kenda"
    company_name = "建大工業"
    news_url = "https://www.建大工業.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 建大工業")
        return documents
