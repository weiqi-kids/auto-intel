...
class ValeoFetcher(CompanyFetcher):
    """Valeo 爬蟲"""

    company_id = "valeo"
    company_name = "Valeo"
    news_url = "https://www.valeo.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Valeo")
        return documents
