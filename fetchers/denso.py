...
class DensoFetcher(CompanyFetcher):
    """電裝 爬蟲"""

    company_id = "denso"
    company_name = "電裝"
    news_url = "https://www.電裝.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 電裝")
        return documents
