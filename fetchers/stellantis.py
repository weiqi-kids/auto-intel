...
class StellantisFetcher(CompanyFetcher):
    """Stellantis 爬蟲"""

    company_id = "stellantis"
    company_name = "Stellantis"
    news_url = "https://www.stellantis.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.stellantis.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Stellantis")
        return documents
