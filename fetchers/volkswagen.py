...
class VolkswagenFetcher(CompanyFetcher):
    """福斯汽車 爬蟲"""

    company_id = "volkswagen"
    company_name = "福斯汽車"
    news_url = "https://www.福斯汽車.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 福斯汽車")
        return documents
