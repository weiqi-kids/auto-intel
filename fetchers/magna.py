...
class MagnaFetcher(CompanyFetcher):
    """Magna International 爬蟲"""

    company_id = "magna"
    company_name = "Magna International"
    news_url = "https://www.magnainternational.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.magnainternational.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Magna International")
        return documents
