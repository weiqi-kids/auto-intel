...
class ContinentalFetcher(CompanyFetcher):
    """Continental 爬蟲"""

    company_id = "continental"
    company_name = "Continental"
    news_url = "https://www.continental.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.continental.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Continental")
        return documents
