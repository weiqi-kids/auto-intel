...
class HyundaiMobisFetcher(CompanyFetcher):
    """現代摩比斯 爬蟲"""

    company_id = "hyundai_mobis"
    company_name = "現代摩比斯"
    news_url = "https://www.現代摩比斯.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 現代摩比斯")
        return documents
