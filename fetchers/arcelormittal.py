...
class ArcelormittalFetcher(CompanyFetcher):
    """ArcelorMittal 爬蟲"""

    company_id = "arcelormittal"
    company_name = "ArcelorMittal"
    news_url = "https://www.arcelormittal.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.arcelormittal.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from ArcelorMittal")
        return documents
