...
class BridgestoneFetcher(CompanyFetcher):
    """普利司通 爬蟲"""

    company_id = "bridgestone"
    company_name = "普利司通"
    news_url = "https://www.普利司通.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 普利司通")
        return documents
