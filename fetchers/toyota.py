...
class ToyotaFetcher(CompanyFetcher):
    """豐田汽車 爬蟲"""

    company_id = "toyota"
    company_name = "豐田汽車"
    news_url = "https://www.豐田汽車.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 豐田汽車")
        return documents
