...
class HondaFetcher(CompanyFetcher):
    """本田汽車 爬蟲"""

    company_id = "honda"
    company_name = "本田汽車"
    news_url = "https://www.本田汽車.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 本田汽車")
        return documents
