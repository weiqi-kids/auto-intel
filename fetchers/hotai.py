...
class HotaiFetcher(CompanyFetcher):
    """和泰汽車 爬蟲"""

    company_id = "hotai"
    company_name = "和泰汽車"
    news_url = "https://www.和泰汽車.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 和泰汽車")
        return documents
