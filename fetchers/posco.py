...
class PoscoFetcher(CompanyFetcher):
    """POSCO 爬蟲"""

    company_id = "posco"
    company_name = "POSCO"
    news_url = "https://www.posco.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from POSCO")
        return documents
