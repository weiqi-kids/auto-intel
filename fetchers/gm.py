...
class GmFetcher(CompanyFetcher):
    """General Motors 爬蟲"""

    company_id = "gm"
    company_name = "General Motors"
    news_url = "https://www.generalmotors.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.generalmotors.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from General Motors")
        return documents
