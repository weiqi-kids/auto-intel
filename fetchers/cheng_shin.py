...
class ChengShinFetcher(CompanyFetcher):
    """正新橡膠 爬蟲"""

    company_id = "cheng_shin"
    company_name = "正新橡膠"
    news_url = "https://www.正新橡膠.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 正新橡膠")
        return documents
